...
export const GROCERY_CATEGORIES: GroceryCategory[] = [
    {
        ...
        items: [
            ...
            { name: "Carne de Soya", searchTerm: "soy meat", emoji: "🌱" },
            { name: "Tempeh", searchTerm: "tempeh", emoji: "🫘" },
            { name: "Seitán", searchTerm: "seitan", emoji: "🍞" },
            { name: "Proteína en polvo", searchTerm: "protein powder", emoji: "🥤" },
        ],
    },
    {
        id: "carbs",
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Pecanas", searchTerm: "pecan", emoji: "🌰" },
            { name: "Pistachos", searchTerm: "pistachio", emoji: "🌰" },
            { name: "Chocolate", searchTerm: "chocolate", emoji: "🍫" },
            { name: "Cacao en Polvo", searchTerm: "cocoa powder", emoji: "🍫" },
        ],
    },
    {
        id: "vegetables",
        ...
        items: [
            ...
            { name: "Cebollín", searchTerm: "green onion", emoji: "🧅" },
            { name: "Acelga", searchTerm: "chard", emoji: "🥬" },
            { name: "Vainitas", searchTerm: "green beans", emoji: "🌿" },
            { name: "Betarraga", searchTerm: "beet", emoji: "🫐" },
            { name: "Rábano", searchTerm: "radish", emoji: "❤️" },
        ],
    },
    {
        id: "fruits",
        ...
        items: [
            ...
            { name: "Granadilla", searchTerm: "granadilla", emoji: "🥭" },
            { name: "Dátiles", searchTerm: "dates", emoji: "🌰" },
            { name: "Pitahaya", searchTerm: "pitahaya", emoji: "🐉" },
        ],
    },
    {
        id: "dairy",
        ...
        items: [
            ...
            { name: "Queso Blanco", searchTerm: "cheese", emoji: "🧀" },
            { name: "Queso Amarillo", searchTerm: "cheddar cheese", emoji: "🧀" },
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Pimentón", searchTerm: "paprika", emoji: "🌶️" },
        ],
    },
];
