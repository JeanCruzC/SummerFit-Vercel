...
const FUNCTIONAL_CATEGORY_OVERRIDES: Record<string, string> = {
    // --- FATS ---
    '31638': 'fat', // Palta (Avocado)
    '27881': 'fat', // Aceite de Oliva / Coco / Chocolate (UI Mapped ID)
    '29934': 'fat', // Maní
    '29952': 'fat', // Mantequilla de Maní
    '29904': 'fat', // Almendras
    '29946': 'fat', // Nueces
    '29939': 'fat', // Pecanas
    '29908': 'fat', // Cashews / Pistachos
    '32504': 'fat', // Aceitunas
    '30005': 'fat', // Chía / Linaza
    '28002': 'fat', // Cacao en Polvo (UI Fat category)

    // --- PROTEINS ---
    '29891': 'protein', // Tofu
    '33238': 'protein', // Tempeh
    '33239': 'protein', // Seitán
    '29866': 'protein', // Carne de Soya
    '33146': 'protein', // Proteína en polvo
    '29568': 'protein', // Huevo (System consistency)

    // --- CARBS ---
    '30815': 'carb', // Quinua
    '30796': 'carb', // Avena
    '30829': 'carb', // Arroz Integral
    '32117': 'carb', // Camote
    '29844': 'carb', // Papa
    '31979': 'carb', // Yuca
};
